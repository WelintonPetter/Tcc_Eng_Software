    ...
    <header>
        <div class="container-back">
            <div class="container-top">
                <li class="drop-hover">
                    <img src="/site/icon/notify.svg" alt="notify" class="notify">
                    ...
                    <img src="/site/icon/avatar.png" alt="Foto de Perfil" class="avatar">
                    <div class="drop">
                        <a href="#">Conta - <?php echo $_SESSION['nome']; ?></a>
                        <a href="/site/views/lembrete.php">Lembrete</a>
                        <a href="#">Empresa</a>
                        <a href="#">Minha Equipe</a>
                        <a href="views/sac.html">Sac</a>
                    </div>
                    
                    <a href="/site/models/logout.php">
                        <img src="/site/icon/log-out.svg" alt="Out" class="out">
                    </a>
                </li>                   
            </div>  
                    ...
                    <div id="carouselExampleControls1" class="carousel slide">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="/site/arquivos/maquina/OIP.jpg" class="d-block w-100" alt="Imagem 1">
                                <div class="carousel-caption d-none d-md-block">
                                    <h5>Texto para Imagem 1</h5>
                                    <p>Descrição da primeira imagem.</p>
                                </div>
                            </div>
                            <div class="carousel-item">
                                <img src="/site/arquivos/avisos/setembro.png" class="d-block w-100" alt="Imagem 2">
                                <div class="carousel-caption d-none d-md-block">
